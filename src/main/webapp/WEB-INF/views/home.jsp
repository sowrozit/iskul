...
<%--<div>--%>
	...
	<%--<nav class="navbar navbar-inverse navbar-fixed-top">--%>
		<%--<div class="container-fluid">--%>
			...
			<%--<ul class="nav navbar-nav navbar-right">--%>
				<%--<li><a href="adminTeacherStudent/profile"><span class="glyphicon glyphicon-user"></span>Welcome ${username} </a></li>--%>
    ...
    <%--</div>--%>
    <%--<div class="login">--%>
        <%--&lt;%&ndash;<h3>Welcome ${username} </h3>&ndash;%&gt;--%>
        <%--<table>--%>
            <%--&lt;%&ndash;<tr>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<td><a href=""></a></td>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</tr>&ndash;%&gt;--%>
            <%--&lt;%&ndash;&lt;%&ndash;<tr>&ndash;%&gt;&ndash;%&gt;--%>
            <%--&lt;%&ndash;<td><a href="admin/usr_manage">view employee list</a></td>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</tr>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<tr>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<td><a href="admin/ctg_manage">view category list</a></td>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</tr>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<tr>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<td><a href="adminTeacher/sub_manage">Click here for view the subjects.</a></td>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</tr>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<tr>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<td><a href="adminTeacher/topic_manage">Click here for view the topics.</a></td>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</tr>&ndash;%&gt;--%>

            <%--&lt;%&ndash;<tr>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<td><a href="adminTeacher/viewPerformance">View Performance</a></td>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</tr>&ndash;%&gt;--%>

            <%--<tr>--%>
                <%--<td><a href="adminManagement">Admin</a></td>--%>
            <%--</tr>--%>
...
<nav class="navbar navbar-transparent navbar-fixed-top navbar-color-on-scroll">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="http://www.creative-tim.com">
                <div class="logo-container">
                    <div class="logo">
                        <img src="/resources/assets/img/logo.png" alt="Creative Tim Logo" rel="tooltip" title="<b>Material Kit</b> was Designed & Coded with care by the staff from <b>Creative Tim</b>" data-placement="bottom" data-html="true">
                    </div>
                    <div class="brand">
                        ISKUL
                    </div>
        ...
        <div class="collapse navbar-collapse" id="navigation-index">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="adminTeacherStudent/profile"><span class="glyphicon glyphicon-user"></span>Welcome ${username} </a>
                </li>
                <li>
                    <a href="adminManagement">Admin</a>
                </li>
                <%--<li>--%>
                    <%--<a href=adminManagement" target="_blank">--%>
                        <%--<i class="material-icons">dashboard</i> Admin--%>
                    <%--</a>--%>
                <%--</li>--%>
                <li>
                    <a href="adminTeacherStudent/atsCategory">view category</a>
                </li>
                <li>
                    <a href="adminTeacher/quiz_manage"> Click Here For view Quiz</a>
                </li>
                <li>
                    <a href="logout">
...
<div class="wrapper">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <c:forEach var="category" items="${listCategoryForAll}">
                                        <a href="/manage/adminTeacherStudent/atsCategoryDetails/?id=${category.id}"><button class="btn btn-primary btn-lg btn btn-primary btn-round" ><i class="material-icons">favorite</i>${category.title}</button></a>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
    ...
    <div class="main main-raised">
            ...
            <div class="container tim-container">
                ...
                <div id="images">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <h4>Rounded Image</h4>
                            <img src="/resources/assets/img/avatar.jpg" alt="Rounded Image" class="img-rounded img-responsive">
                        </div>
                        <div class="col-sm-2 col-sm-offset-1">
                            <h4>Circle Image</h4>
                            <img src="/resources/assets/img/avatar.jpg" alt="Circle Image" class="img-circle img-responsive">
                        </div>
                        <div class="col-sm-2 col-sm-offset-1">
                            <h4>Rounded Raised</h4>
                            <img src="/resources/assets/img/avatar.jpg" alt="Raised Image" class="img-rounded img-responsive img-raised">
                        </div>

                        <div class="col-sm-2 col-sm-offset-1">
                            <h4>Circle Raised</h4>
                            <img src="/resources/assets/img/avatar.jpg" alt="Thumbnail Image" class="img-circle img-raised img-responsive">
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <img src="/resources/assets/img/bg2.jpeg" alt="Awesome Image">
                                            <div class="carousel-caption">
                                                <h4><i class="material-icons">location_on</i> Yellowstone National Park, United States</h4>
                                            </div>
                                        </div>
                                        <div class="item">
                                            <img src="/resources/assets/img/bg3.jpeg" alt="Awesome Image">
                                            <div class="carousel-caption">
                                                <h4><i class="material-icons">location_on</i> Somewhere Beyond, United States</h4>
                                            </div>
                                        </div>
                                        <div class="item">
                                            <img src="/resources/assets/img/bg4.jpeg" alt="Awesome Image">
                                            <div class="carousel-caption">
                                                <h4><i class="material-icons">location_on</i> Yellowstone National Park, United States</h4>
                                            </div>
                                        </div>
        ...
        <div class="section section-full-screen section-signup" style="background-image: url('/resources/assets/img/city.jpg'); background-size: cover; background-position: top center; min-height: 700px;">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="examples/landing-page.html" target="_blank">
                            <img src="/resources/assets/img/landing.jpg" alt="Rounded Image" class="img-rounded img-raised img-responsive">
                            <button class="btn  btn-simple btn-primary btn-lg">View Landing Page</button>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="examples/profile-page.html" target="_blank">
                            <img src="/resources/assets/img/profile.jpg" alt="Rounded Image" class="img-rounded img-raised img-responsive">
